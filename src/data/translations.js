export const translations = {
  ...
  he: {
    ...
    instructors: 'המדריכים שלנו',
    adminButton: 'מנהל',
    uploadSchedule: 'העלה לוח אירועים',
    eventScheduleTitle: 'לוח אירועים',
    eventScheduleSubtitle: 'בדקו את האירועים השבועיים והסשנים הקרובים שלנו',
    eventScheduleLoading: 'טוען לוח אירועים...',
    eventScheduleEmpty: 'אין אירועים מתוכננים כרגע. חזרו בקרוב!',
    eventScheduleError: 'אירעה שגיאה בעת טעינת לוח האירועים. נסו שוב מאוחר יותר.',
