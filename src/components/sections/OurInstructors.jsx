        ...
        <div className="relative max-w-6xl mx-auto">
          {currentInstructor && (
            <div className="relative overflow-hidden rounded-3xl bg-white/5 backdrop-blur-md border border-white/10" style={{ minHeight: '420px' }}>
              ...
              >
                <div className="relative h-[420px] sm:h-[460px] md:h-[520px] flex items-center justify-center bg-black/30 overflow-hidden">
                  <StorageImage
                    storageId={currentInstructor.photo_url || DEFAULT_INSTRUCTOR_PHOTO}
                    alt={currentInstructor.name}
                    className="w-full h-full object-cover object-[center_20%] transition-transform duration-700 group-hover:scale-[1.01]"
                  />
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div
                ...
                className="relative h-80 sm:h-96 md:h-full min-h-[400px] w-full rounded-lg overflow-hidden"
              >
                <StorageImage
