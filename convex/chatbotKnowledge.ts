    ...
    return {
      ...
      services: [
        {
          ...
          price: "₪500",
          description: "סדנה אישית שבמהלכה נעבוד על איפוס טוטאלי של המערכות החיוניות בגוף. מדובר בסדנה מאוד חווייתית שהמטרות המרכזיות שלה הן לתת שוק למערכת העצבים על מנת להוציא את כל הסטרס מהגוף, לעורר את מערכת החיסון ולאמן את מערכת הדם.",
          includes: [
        ...
        },
        {
          ...
          price: "₪650",
          description: "סדנה זוגית חווייתית שבמהלכה נעבוד על איפוס טוטאלי של המערכות החיוניות בגוף. חוויה משותפת של שבירת גבולות, חיזוק מערכת החיסון ואימון מערכת הדם.",
          includes: [
        ...
        },
        {
          ...
          description: "סדנאות מותאמות אישית לחברות וארגונים לחיזוק הצוות, שיפור ביצועים והתמודדות עם סטרס",
          benefits: [
      ...
      packages: [
        ...
        },
        {
          ...
          benefits: ["גמישות חודשית - Monthly flexibility", "אין התחייבות ארוכת טווח - No long-term commitment"]
        },
        {
          type: "6-months",
          ...
          benefits: ["חיסכון משמעותי - Significant savings", "מחויבות לתהליך - Commitment to the process"]
        }
      ],
      benefits: [
        {
          title: "התמודדות עם סטרס - Stress Management",
          description: "התמודדות יעילה עם סטרס ואימון מערכת העצבים להוציא אותו החוצה ע\"י טבילה במי קרח",
          icon: "🧘"
        },
        {
        ...
        },
        {
          ...
          description: "התאוששות מהירה מפציעות, האצת תהליכים אנטי דלקטיים והגברת ייצור דופמין (פי 250% מהנורמה!)",
          icon: "⚡"
        },
        {
      ...
      faq: [
        ...
        },
        {
          ...
          answer: "Our ice baths are maintained at 0-3°C (32-37°F) - the optimal temperature for maximum benefits and transformation. - אמבטיות הקרח שלנו בטמפרטורה של 0-3 מעלות צלזיוס - הטמפרטורה האופטימלית לתוצאות מקסימליות."
        },
        {
        ...
        },
        {
          ...
          answer: "Each transformative session lasts 60-90 minutes, including powerful breathing exercises, theory, and the ice bath experience. - כל פגישה משנת חיים נמשכת 60-90 דקות, כולל תרגילי נשימה עוצמתיים, תיאוריה וחוויית אמבט הקרח."
        },
        {
        ...
        },
        {
          ...
          answer: "We're located at Ben Yehuda 30, Herzliya, Israel. Easy to reach and plenty of parking available. - אנחנו נמצאים ברחוב בן יהודה 30, הרצליה, ישראל. קל להגיע ויש הרבה חניות."
        },
        {
          question: "Do you offer corporate workshops? - האם אתם מציעים סדנאות לחברות?",
          answer: "Yes! We offer customized corporate workshops for team building, performance improvement, and stress management. Contact us for details. - כן! אנחנו מציעים סדנאות מותאמות אישית לחברות לחיזוק צוות, שיפור ביצועים והתמודדות עם סטרס. צרו קשר לפרטים."
        },
        {
          question: "Can I become a certified instructor? - האם אני יכול להיות מדריך מוסמך?",
          answer: "Yes! We offer professional instructor training courses. You'll receive recognized certification and personal mentorship from Dan. - כן! אנחנו מציעים קורסים מקצועיים להכשרת מדריכים. תקבלו תעודה מוכרת וליווי אישי מדן."
        },
        {
          question: "What's included in the membership packages? - מה כלול במנויים?",
          answer: "Our memberships include unlimited access to all classes (breathing, yoga, movement, sound healing, meditation), gym access, ice baths, jacuzzi, and saunas. The 6-month package also includes a personal training program and welcome gift. - המנויים שלנו כוללים גישה חופשית לכל השיעורים (נשימה, יוגה, תנועה, סאונד-הילינג, מדיטציה), חדר כושר, אמבטיות קרח, ג'אקוזי וסאונות. מנוי 6 חודשים כולל גם תוכנית אימונים אישית ומתנת הצטרפות."
        }
      ],
      breathingTechniques: [
        {
          name: "Wim Hof Method - שיטת ווים הוף",
          description: "The signature breathing technique combining controlled hyperventilation with breath retention"
        },
        {
        ...
        },
        {
          ...
          description: "Deep, rapid breathing for altered states of consciousness and emotional release"
        }
      ],
      facilities: [
